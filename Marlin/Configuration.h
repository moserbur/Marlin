...
#define STRING_CONFIG_H_AUTHOR "Burkhard Moser" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Burkhard's 3D Drucker"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //CubeXY 220V 0,75kW
  #define DEFAULT_bedKp 16
  #define DEFAULT_bedKi 1.75
  #define DEFAULT_bedKd 93
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 200, 200, 400, 156 }
 ...
 */
//-0,55 with "current" probe position
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, -0.55 }
